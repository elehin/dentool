...
$(document).ready(function() {
	...
	if (getUrlParameter("usuario") != '') {
		getUsuario(getUrlParameter("usuario"));
	}
...
function checkPwdStrength() {
	if (getPwdStrength($("#password").val()) == 'empty') {
	...
	} else if (getPwdStrength($("#password").val()) == 'short') {
		$('#passwordDiv .glyphicon-ok.form-control-feedback').remove();
		$('#passwordDiv').removeClass("has-success has-feedback");
		$("#passwordDiv").addClass("has-error has-feedback");
		$("#passwordDiv")
