				...
				function() {
					...
					$("#btnAdd").click(function() {
						...
						$("#pacienteForm")[0].reset();
						 $("#contentCol1").addClass('in');
						// $("#divFormPaciente").show();
						// $("#leftArea").show();
						// $("#rightArea").show();
						return false;
					});
 ...
 *  // create message and show it $('<div id="messages">').attr('class',
 * style).html(message).fadeIn('fast').insertBefore( $('#pacienteForm')) // <==
 * wherever you want it to show .animate({ opacity : 1.0 }, 4000) // <== wait 4
 * sec before fading out .fadeOut('slow', function() { $(this).remove(); }); }
 */
