...
public class Gabinete {
	...
	@Id
	@SequenceGenerator(name = "gabinete_id_seq", sequenceName = "gabinete_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gabinete_id_seq")
